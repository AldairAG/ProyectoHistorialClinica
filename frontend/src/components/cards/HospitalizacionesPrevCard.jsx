        ...
        <Card className={'p-0'}>
            ...
            <div className="max-h-[500px] overflow-auto flex flex-col gap-4 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100">
                {pacienteSelect?.hospitalizacionesPrevias?.map((item, index) => (
                    <div key={index}
                        className="bg-gray-50 border border-s-4 border-gray-300 border-s-black rounded-md p-4">
                        ...
                        <div className="grid grid-cols-2 pb-3">
                            <div>
                                <div className="text-sm text-gray-500 font-semibold">
                                    ...
                                    <label className="ps-5 text-gray-700 text-base">{item.motivo}</label>
                                </div>
                                <div className="text-sm text-gray-500 font-semibold">
                                    <div className="flex gap-1">
                                    ...
                                    <label className="ps-5 text-gray-700 text-base">{item.institucion}</label>
                                </div>
                                <div className="text-sm text-gray-500 font-semibold">
                                    <div className="flex gap-1">
                                    ...
                                    <label className="ps-5 text-gray-700 text-base">{item.diagnostico}</label>
                                </div>
                            </div>
                            <div>
                                <div className="text-sm text-gray-500 font-semibold">
                                    ...
                                    <label className="ps-5 text-gray-700 text-base">{item.fechaIngreso}</label>
                                </div>
                                <div className="text-sm text-gray-500 font-semibold">
                                    <div className="flex gap-1">
                                    ...
                                    <label className="ps-5 text-gray-700 text-base">{item.duracion} dias</label>
                                </div>
                            </div>
                        </div>
                        <div className="text-sm text-gray-500 font-semibold border-t border-gray-300 pt-2">
                            ...
                            <label className="ps-5 text-gray-700 text-base">{item.tratamiento}</label>
                        </div>
                    </div>
...
export default HospitalizacionesPrecCard;