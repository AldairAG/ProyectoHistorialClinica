...
// Componente para las acciones (botón Ver)
...
const PacientesTable = ({ className, variant = "default" }) => {
  ...
  return (
    <div className={twMerge("flex flex-col md:flex-row", className)}>
      {/* Filtros Sidebar - Solo se muestra si no es variante "home" */}
      {variant !== 'home' && (
        <Card className="w-full md:w-1/4 bg-white p-4 md:p-6 rounded-lg shadow mb-4 md:mb-0 md:mr-4">
          <CardHead>
            <CardHeader className="text-xl font-bold">Filtros</CardHeader>
      ...
      {/* Tabla de pacientes */}
      <Card className={`w-full ${variant !== 'home' ? 'md:w-3/4' : ''} bg-white p-4 md:p-6 rounded-lg shadow`}>
        {/* Encabezado - Título y Botón Añadir */}
        ...
        {/* Barra de búsqueda para la variante home */}
        {variant === 'home' && (
          <div className="relative mb-6">
            <Input
              type="text"
